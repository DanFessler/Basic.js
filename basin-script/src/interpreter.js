...
// TODO:
// type checking all functions
// runtime error handling for functions

class Basin {
  constructor() {
    this.Stack = [];
    this.shouldUpdate = true;
    this.import(require("./plugins/core.js"), this);
    this.import(require("./plugins/logic.js"), this);
    this.import(require("./plugins/math.js"), this);
  }
